...
* Dong-Hyun Yook 2018/05/18 1.0 chat_clnt.c is generated
* ======================================================================*/
...
int main(int argc, char *argv[])
{
	...
	// 예시) gcc -o c clnt.c-> 총 4개의 문자열 "gcc", "-o", "c", "clnt.c"로 구성, 따라서 argc는 4이다.
	// 여기서 argv[0]는 gcc이고, argv[1]는 -o, argv[2]는 c, argv[3]는 clnt.c
	int sock;
	pid_t pid;
