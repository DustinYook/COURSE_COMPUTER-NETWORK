...
* File Name: "serv.c"
* Description:
* - This program is the echo select server program
*   which is implemeted by using select function to track
*   which file descripter is changed
...
* Dong-Hyun Yook 2018/05/17 1.0 serv.c is generated
* ======================================================================*/
...
int main(int argc, char *argv[])
{
	...
	while (1)
	{
		...
		for (i = 0; i < fd_max + 1; i++)
		{
			...
			{
				if (i == serv_sock) // 연결요청이 있는 경우 (서버소켓의 변화감지)
				{
